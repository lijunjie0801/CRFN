//
//  FittingsCenterViewController.m
//  CRFN
//配件中心
...
@interface FittingsCenterViewController ()<UITextFieldDelegate,UITextFieldDelegate,UISearchBarDelegate,UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate,PulldownMenuDelegate,UICollectionViewDataSource>
{
...
@implementation FittingsCenterViewController
-(instancetype)init
{
    self = [super init];
    if (self) {
        
        self.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"woyun" image:[UIImage imageNamed:@"peijianzhongxin"] tag:1];
        //self.tabBarItem.selectedImage=[UIImage imageNamed:@"shouye_sel"];
//        self.title = @"首页";
        self.tabBarItem.title = @"配件中心";
        //调整tabbaritem中文字的位置
...
-(void)requestData
{
    ...
    NSDictionary *param =@{@"cid":@"142",@"province":[AppDataManager defaultManager].ProvinceId};
