...
@interface goodCellCollectionViewCell()

@property(nonatomic, strong) UIImageView *goodImg;
@property(nonatomic, strong) UILabel *nameLbl,*priceLbl,*oldprice;
...
@implementation goodCellCollectionViewCell
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        if (!_buyBtn) {
            ...
            [self addSubview:_buyBtn];
             ...
             CGFloat w = [@"马上抢" boundingRectWithSize:CGSizeMake(MAXFLOAT, [MyAdapter aDapter:21]) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[MyAdapter fontADapter:14]} context:nil].size.width;
...
//            _oldprice.font =[MyAdapter lfontADapter:14];
//            _oldprice.textAlignment = NSTextAlignmentCenter;
//            [self addSubview:_oldprice];
//            _oldprice.textColor = [AppAppearance sharedAppearance].title2TextColor;
...
//        }
        ...
        if (!_priceLbl) {
            ...
            _priceLbl.textColor = [AppAppearance sharedAppearance].redColor;
...
-(void)setHomeModel:(HomeModel *)homeModel
{
    ...
    NSString *priceTitle = [NSString stringWithFormat:@"￥%@",homeModel.goodSellPrice];
    _priceLbl.text = priceTitle;
//     CGFloat w = [priceTitle boundingRectWithSize:CGSizeMake(MAXFLOAT, [MyAdapter aDapter:21]) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[MyAdapter fontADapter:14]} context:nil].size.width;
...
//    NSString *oldpriceTitle = [NSString stringWithFormat:@"￥%@",homeModel.goodMarketPrice];
//    _oldprice.text = oldpriceTitle;
    
    
    
//     CGFloat oldPriceW = [homeModel.goodMarketPrice boundingRectWithSize:CGSizeMake(MAXFLOAT, [MyAdapter aDapter:21]) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[MyAdapter fontADapter:14]} context:nil].size.width +15;
    
    
//    [self.oldprice mas_makeConstraints:^(MASConstraintMaker *make) {
//        
////        make.right.equalTo(_buyBtn.mas_left).offset(0);
//        make.left.equalTo(_priceLbl.mas_right).offset(5);
...
//    rectL.origin.x = _oldprice.x ;
//    rectL.origin.y = CGRectGetMidY(_oldprice.frame);
//    rectL.size.width = _oldprice.width;
//    rectL.size.height = 1;
//    layer.frame = rectL;
