...
-(UIPageControl *)pageControl
{
    if(!_pageControl)
    {
        _pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(CGRectGetWidth(self.bounds)-100, CGRectGetHeight(self.bounds) - 20, 140, 20)];
       ...
       // _pageControl.pageIndicatorTintColor = UIColorFromRGB(0xbebfb6);
        _pageControl.pageIndicatorTintColor = [AppAppearance sharedAppearance].whiteColor;
        _pageControl.currentPageIndicatorTintColor = [AppAppearance sharedAppearance].redColor;
